...
/**
 * Created by weicy on 2017/11/17.
 */
...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (discountPrice ==5199 ){
            Glide.with(context).load(R.drawable.tuijian).into(childViewHolder.id_iv_logo);
        }else if (discountPrice ==2999 ){
            Glide.with(context).load(R.drawable.tuijian1).into(childViewHolder.id_iv_logo);
        }else if (discountPrice ==7288 ){
            Glide.with(context).load(R.drawable.iphone).into(childViewHolder.id_iv_logo);
        }
